...
--
-- Servidor: localhost
-- Tiempo de generación: 28-03-2012 a las 08:28:56
...
-- Base de datos: `dinco`
--
CREATE DATABASE `dinco` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `dinco`;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `dinco_assets`
--

CREATE TABLE IF NOT EXISTS `dinco_assets` (
...
--
-- Volcar la base de datos para la tabla `dinco_assets`
--

INSERT INTO `dinco_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
--
-- Estructura de tabla para la tabla `dinco_associations`
--

CREATE TABLE IF NOT EXISTS `dinco_associations` (
...
--
-- Volcar la base de datos para la tabla `dinco_associations`
--
...
--
-- Estructura de tabla para la tabla `dinco_banner_clients`
--

CREATE TABLE IF NOT EXISTS `dinco_banner_clients` (
...
--
-- Volcar la base de datos para la tabla `dinco_banner_clients`
--
...
--
-- Estructura de tabla para la tabla `dinco_banner_tracks`
--

CREATE TABLE IF NOT EXISTS `dinco_banner_tracks` (
...
--
-- Volcar la base de datos para la tabla `dinco_banner_tracks`
--
...
--
-- Estructura de tabla para la tabla `dinco_banners`
--

CREATE TABLE IF NOT EXISTS `dinco_banners` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Volcar la base de datos para la tabla `dinco_banners`
--
...
--
-- Estructura de tabla para la tabla `dinco_categories`
--

CREATE TABLE IF NOT EXISTS `dinco_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Volcar la base de datos para la tabla `dinco_categories`
--

INSERT INTO `dinco_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`) VALUES
...
--
-- Estructura de tabla para la tabla `dinco_contact_details`
--

CREATE TABLE IF NOT EXISTS `dinco_contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Volcar la base de datos para la tabla `dinco_contact_details`
--
...
--
-- Estructura de tabla para la tabla `dinco_content`
--

CREATE TABLE IF NOT EXISTS `dinco_content` (
...
--
-- Volcar la base de datos para la tabla `dinco_content`
--
...
--
-- Estructura de tabla para la tabla `dinco_content_frontpage`
--

CREATE TABLE IF NOT EXISTS `dinco_content_frontpage` (
...
--
-- Volcar la base de datos para la tabla `dinco_content_frontpage`
--
...
--
-- Estructura de tabla para la tabla `dinco_content_rating`
--

CREATE TABLE IF NOT EXISTS `dinco_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Volcar la base de datos para la tabla `dinco_content_rating`
--
...
--
-- Estructura de tabla para la tabla `dinco_core_log_searches`
--

CREATE TABLE IF NOT EXISTS `dinco_core_log_searches` (
  `search_term` varchar(128) NOT NULL DEFAULT '',
  `hits` int(10) unsigned NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Volcar la base de datos para la tabla `dinco_core_log_searches`
--
...
--
-- Estructura de tabla para la tabla `dinco_extensions`
--

CREATE TABLE IF NOT EXISTS `dinco_extensions` (
...
--
-- Volcar la base de datos para la tabla `dinco_extensions`
--

INSERT INTO `dinco_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
--
-- Volcar la base de datos para la tabla `dinco_finder_filters`
--
...
--
-- Estructura de tabla para la tabla `dinco_finder_links`
--

CREATE TABLE IF NOT EXISTS `dinco_finder_links` (
...
--
-- Volcar la base de datos para la tabla `dinco_finder_links`
--
...
--
-- Estructura de tabla para la tabla `dinco_finder_links_terms0`
--

CREATE TABLE IF NOT EXISTS `dinco_finder_links_terms0` (
...
--
-- Volcar la base de datos para la tabla `dinco_finder_links_terms0`
--
...
--
-- Estructura de tabla para la tabla `dinco_finder_links_terms1`
--

CREATE TABLE IF NOT EXISTS `dinco_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Volcar la base de datos para la tabla `dinco_finder_links_terms1`
--
...
--
-- Estructura de tabla para la tabla `dinco_finder_links_terms2`
--

CREATE TABLE IF NOT EXISTS `dinco_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Volcar la base de datos para la tabla `dinco_finder_links_terms2`
--
...
--
-- Estructura de tabla para la tabla `dinco_finder_links_terms3`
--

CREATE TABLE IF NOT EXISTS `dinco_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Volcar la base de datos para la tabla `dinco_finder_links_terms3`
--
...
--
-- Estructura de tabla para la tabla `dinco_finder_links_terms4`
--

CREATE TABLE IF NOT EXISTS `dinco_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Volcar la base de datos para la tabla `dinco_finder_links_terms4`
--
...
--
-- Estructura de tabla para la tabla `dinco_finder_links_terms5`
--

CREATE TABLE IF NOT EXISTS `dinco_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Volcar la base de datos para la tabla `dinco_finder_links_terms5`
--
...
--
-- Estructura de tabla para la tabla `dinco_finder_links_terms6`
--

CREATE TABLE IF NOT EXISTS `dinco_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Volcar la base de datos para la tabla `dinco_finder_links_terms6`
--
...
--
-- Estructura de tabla para la tabla `dinco_finder_links_terms7`
--

CREATE TABLE IF NOT EXISTS `dinco_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Volcar la base de datos para la tabla `dinco_finder_links_terms7`
--
...
--
-- Estructura de tabla para la tabla `dinco_finder_links_terms8`
--

CREATE TABLE IF NOT EXISTS `dinco_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Volcar la base de datos para la tabla `dinco_finder_links_terms8`
--
...
--
-- Estructura de tabla para la tabla `dinco_finder_links_terms9`
--

CREATE TABLE IF NOT EXISTS `dinco_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Volcar la base de datos para la tabla `dinco_finder_links_terms9`
--
...
--
-- Estructura de tabla para la tabla `dinco_finder_links_termsa`
--

CREATE TABLE IF NOT EXISTS `dinco_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Volcar la base de datos para la tabla `dinco_finder_links_termsa`
--
...
--
-- Estructura de tabla para la tabla `dinco_finder_links_termsb`
--

CREATE TABLE IF NOT EXISTS `dinco_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Volcar la base de datos para la tabla `dinco_finder_links_termsb`
--
...
--
-- Estructura de tabla para la tabla `dinco_finder_links_termsc`
--

CREATE TABLE IF NOT EXISTS `dinco_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Volcar la base de datos para la tabla `dinco_finder_links_termsc`
--
...
--
-- Estructura de tabla para la tabla `dinco_finder_links_termsd`
--

CREATE TABLE IF NOT EXISTS `dinco_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Volcar la base de datos para la tabla `dinco_finder_links_termsd`
--
...
--
-- Estructura de tabla para la tabla `dinco_finder_links_termse`
--

CREATE TABLE IF NOT EXISTS `dinco_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Volcar la base de datos para la tabla `dinco_finder_links_termse`
--
...
--
-- Estructura de tabla para la tabla `dinco_finder_links_termsf`
--

CREATE TABLE IF NOT EXISTS `dinco_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Volcar la base de datos para la tabla `dinco_finder_links_termsf`
--
...
--
-- Estructura de tabla para la tabla `dinco_finder_taxonomy`
--

CREATE TABLE IF NOT EXISTS `dinco_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Volcar la base de datos para la tabla `dinco_finder_taxonomy`
--

INSERT INTO `dinco_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `dinco_finder_taxonomy_map`
--

CREATE TABLE IF NOT EXISTS `dinco_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Volcar la base de datos para la tabla `dinco_finder_taxonomy_map`
--
...
--
-- Estructura de tabla para la tabla `dinco_finder_terms`
--

CREATE TABLE IF NOT EXISTS `dinco_finder_terms` (
...
--
-- Volcar la base de datos para la tabla `dinco_finder_terms`
--
...
--
-- Estructura de tabla para la tabla `dinco_finder_terms_common`
--

CREATE TABLE IF NOT EXISTS `dinco_finder_terms_common` (
  `term` varchar(75) NOT NULL,
...
--
-- Volcar la base de datos para la tabla `dinco_finder_terms_common`
--

INSERT INTO `dinco_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Estructura de tabla para la tabla `dinco_finder_tokens`
--

CREATE TABLE IF NOT EXISTS `dinco_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Volcar la base de datos para la tabla `dinco_finder_tokens`
--
...
--
-- Estructura de tabla para la tabla `dinco_finder_tokens_aggregate`
--

CREATE TABLE IF NOT EXISTS `dinco_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- Volcar la base de datos para la tabla `dinco_finder_tokens_aggregate`
--
...
--
-- Estructura de tabla para la tabla `dinco_finder_types`
--

CREATE TABLE IF NOT EXISTS `dinco_finder_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Volcar la base de datos para la tabla `dinco_finder_types`
--
...
--
-- Estructura de tabla para la tabla `dinco_languages`
--

CREATE TABLE IF NOT EXISTS `dinco_languages` (
...
--
-- Volcar la base de datos para la tabla `dinco_languages`
--

INSERT INTO `dinco_languages` (`lang_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `ordering`) VALUES
(1, 'en-GB', 'English (UK)', 'English (UK)', 'en', 'en', '', '', '', '', 1, 1);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `dinco_menu`
--

CREATE TABLE IF NOT EXISTS `dinco_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Volcar la base de datos para la tabla `dinco_menu`
--

INSERT INTO `dinco_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `ordering`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
--
-- Estructura de tabla para la tabla `dinco_menu_types`
--

CREATE TABLE IF NOT EXISTS `dinco_menu_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Volcar la base de datos para la tabla `dinco_menu_types`
--

INSERT INTO `dinco_menu_types` (`id`, `menutype`, `title`, `description`) VALUES
(1, 'mainmenu', 'Main Menu', 'The main menu for the site');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `dinco_messages`
--

CREATE TABLE IF NOT EXISTS `dinco_messages` (
...
--
-- Volcar la base de datos para la tabla `dinco_messages`
--
...
--
-- Estructura de tabla para la tabla `dinco_messages_cfg`
--

CREATE TABLE IF NOT EXISTS `dinco_messages_cfg` (
...
--
-- Volcar la base de datos para la tabla `dinco_messages_cfg`
--
...
--
-- Estructura de tabla para la tabla `dinco_modules`
--

CREATE TABLE IF NOT EXISTS `dinco_modules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Volcar la base de datos para la tabla `dinco_modules`
--

INSERT INTO `dinco_modules` (`id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
(1, 'Main Menu', '', '', 1, 'position-1', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_menu', 1, 1, '{"menutype":"mainmenu","startLevel":"1","endLevel":"0","showAllChildren":"0","tag_id":"","class_sfx":"span-24","window_open":"","layout":"_:default","moduleclass_sfx":"_menu","cache":"1","cache_time":"900","cachemode":"itemid"}', 0, '*'),
...
(17, 'Breadcrumbs', '', '', 1, 'position-2', 42, '2012-02-03 03:33:40', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_breadcrumbs', 1, 1, '{"moduleclass_sfx":"","showHome":"1","homeText":"Home","showComponent":"1","separator":"","cache":"1","cache_time":"900","cachemode":"itemid"}', 0, '*'),
(79, 'Multilanguage status', '', '', 1, 'status', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'mod_multilangstatus', 3, 1, '{"layout":"_:default","moduleclass_sfx":"","cache":"0"}', 1, '*'),
(86, 'Joomla Version', '', '', 1, 'footer', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_version', 3, 1, '{"format":"short","product":"1","layout":"_:default","moduleclass_sfx":"","cache":"0"}', 1, '*'),
(87, 'slider', '', '<p>//Referencia usuando google</p>', 1, 'position-12', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'mod_custom', 1, 0, '{"prepare_content":"1","backgroundimage":"","layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"static"}', 0, '*'),
(88, 'showplus', '', '', 1, 'position-12', 42, '2012-02-08 04:20:01', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_showplus', 1, 0, '{"folder":"images\\/slide","width":"750","height":"300","alignment":"center","orientation":"horizontal","buttons":"0","captions":"0","defcaption":"","deflink":"","target":"_self","delay":"3000","duration":"800","transition":"fade","transition_easing":"expo","transition_pan":"0","transition_zoom":"0","margin":"","border_style":"none","border_width":"","border_color":"","padding":"","background_color":"","thumb_width":"0","thumb_height":"0","links":"0","thumb_cache":"1","thumb_folder":"thumbs","thumb_quality":"85","labels":"labels","labels_multilingual":"0","labels_captions":"","sort_criterion":"labels-filename","sort_order":"0","library":"default","moduleclass_sfx":"","debug":"0"}', 0, '*');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `dinco_modules_menu`
--

CREATE TABLE IF NOT EXISTS `dinco_modules_menu` (
...
--
-- Volcar la base de datos para la tabla `dinco_modules_menu`
--

INSERT INTO `dinco_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Estructura de tabla para la tabla `dinco_newsfeeds`
--

CREATE TABLE IF NOT EXISTS `dinco_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Volcar la base de datos para la tabla `dinco_newsfeeds`
--
...
--
-- Estructura de tabla para la tabla `dinco_overrider`
--

CREATE TABLE IF NOT EXISTS `dinco_overrider` (
...
--
-- Volcar la base de datos para la tabla `dinco_overrider`
--
...
--
-- Estructura de tabla para la tabla `dinco_redirect_links`
--

CREATE TABLE IF NOT EXISTS `dinco_redirect_links` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Volcar la base de datos para la tabla `dinco_redirect_links`
--
...
--
-- Estructura de tabla para la tabla `dinco_schemas`
--

CREATE TABLE IF NOT EXISTS `dinco_schemas` (
...
--
-- Volcar la base de datos para la tabla `dinco_schemas`
--

INSERT INTO `dinco_schemas` (`extension_id`, `version_id`) VALUES
(700, '2.5.1-2012-01-26');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `dinco_session`
--

CREATE TABLE IF NOT EXISTS `dinco_session` (
...
--
-- Volcar la base de datos para la tabla `dinco_session`
--

INSERT INTO `dinco_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`, `usertype`) VALUES
('tl6pu8sefpodcqh2jl1jfvim64', 0, 1, '1328676480', '__default|a:7:{s:15:"session.counter";i:49;s:19:"session.timer.start";i:1328670484;s:18:"session.timer.last";i:1328676477;s:17:"session.timer.now";i:1328676480;s:22:"session.client.browser";s:105:"Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/535.7 (KHTML, like Gecko) Chrome/16.0.912.77 Safari/535.7";s:8:"registry";O:9:"JRegistry":1:{s:7:"\0*\0data";O:8:"stdClass":0:{}}s:4:"user";O:5:"JUser":23:{s:9:"\0*\0isRoot";b:0;s:2:"id";i:0;s:4:"name";N;s:8:"username";N;s:5:"email";N;s:8:"password";N;s:14:"password_clear";s:0:"";s:8:"usertype";N;s:5:"block";N;s:9:"sendEmail";i:0;s:12:"registerDate";N;s:13:"lastvisitDate";N;s:10:"activation";N;s:6:"params";N;s:6:"groups";a:0:{}s:5:"guest";i:1;s:10:"\0*\0_params";O:9:"JRegistry":1:{s:7:"\0*\0data";O:8:"stdClass":0:{}}s:14:"\0*\0_authGroups";a:1:{i:0;i:1;}s:14:"\0*\0_authLevels";a:2:{i:0;i:1;i:1;i:1;}s:15:"\0*\0_authActions";N;s:12:"\0*\0_errorMsg";N;s:10:"\0*\0_errors";a:0:{}s:3:"aid";i:0;}}', 0, '', '');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `dinco_template_styles`
--

CREATE TABLE IF NOT EXISTS `dinco_template_styles` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Volcar la base de datos para la tabla `dinco_template_styles`
--

INSERT INTO `dinco_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
(2, 'bluestork', 1, '1', 'Bluestork - Default', '{"useRoundedCorners":"1","showSiteName":"0"}'),
(3, 'atomic', 0, '0', 'Atomic - Default', '{}'),
(4, 'beez_20', 0, '0', 'Beez2 - Default', '{"wrapperSmall":"53","wrapperLarge":"72","logo":"images\\/joomla_black.gif","sitetitle":"Joomla!","sitedescription":"Open Source Content Management","navposition":"left","templatecolor":"personal","html5":"0"}'),
(5, 'hathor', 1, '0', 'Hathor - Default', '{"showSiteName":"0","colourChoice":"","boldText":"0"}'),
(6, 'beez5', 0, '1', 'Beez5 - Default', '{"wrapperSmall":53,"wrapperLarge":72,"logo":"images\\/sampledata\\/fruitshop\\/logo.png","sitetitle":"Dinco","sitedescription":"","navposition":"left","html5":0}');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `dinco_update_categories`
--

CREATE TABLE IF NOT EXISTS `dinco_update_categories` (
...
--
-- Volcar la base de datos para la tabla `dinco_update_categories`
--
...
--
-- Estructura de tabla para la tabla `dinco_update_sites`
--

CREATE TABLE IF NOT EXISTS `dinco_update_sites` (
...
--
-- Volcar la base de datos para la tabla `dinco_update_sites`
--

INSERT INTO `dinco_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`) VALUES
(1, 'Joomla Core', 'collection', 'http://update.joomla.org/core/list.xml', 1, 1328671268),
(2, 'Joomla Extension Directory', 'collection', 'http://update.joomla.org/jed/list.xml', 1, 1328671268);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `dinco_update_sites_extensions`
--

CREATE TABLE IF NOT EXISTS `dinco_update_sites_extensions` (
...
--
-- Volcar la base de datos para la tabla `dinco_update_sites_extensions`
--

INSERT INTO `dinco_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700);
...
--
-- Estructura de tabla para la tabla `dinco_updates`
--

CREATE TABLE IF NOT EXISTS `dinco_updates` (
...
--
-- Volcar la base de datos para la tabla `dinco_updates`
--
...
--
-- Estructura de tabla para la tabla `dinco_user_notes`
--

CREATE TABLE IF NOT EXISTS `dinco_user_notes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Volcar la base de datos para la tabla `dinco_user_notes`
--
...
--
-- Estructura de tabla para la tabla `dinco_user_profiles`
--

CREATE TABLE IF NOT EXISTS `dinco_user_profiles` (
...
--
-- Volcar la base de datos para la tabla `dinco_user_profiles`
--
...
--
-- Estructura de tabla para la tabla `dinco_user_usergroup_map`
--

CREATE TABLE IF NOT EXISTS `dinco_user_usergroup_map` (
...
--
-- Volcar la base de datos para la tabla `dinco_user_usergroup_map`
--

INSERT INTO `dinco_user_usergroup_map` (`user_id`, `group_id`) VALUES
(42, 8);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `dinco_usergroups`
--

CREATE TABLE IF NOT EXISTS `dinco_usergroups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
...
--
-- Volcar la base de datos para la tabla `dinco_usergroups`
--

INSERT INTO `dinco_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 20, 'Public'),
(2, 1, 6, 17, 'Registered'),
(3, 2, 7, 14, 'Author'),
(4, 3, 8, 11, 'Editor'),
...
--
-- Estructura de tabla para la tabla `dinco_users`
--

CREATE TABLE IF NOT EXISTS `dinco_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Volcar la base de datos para la tabla `dinco_users`
--

INSERT INTO `dinco_users` (`id`, `name`, `username`, `email`, `password`, `usertype`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`) VALUES
(42, 'Super User', 'admin', 'salvador@sigues.org', '5fdda147d482968f69686264284a3590:mekFUadncURKxxYRrcZvzx7aFUlToiss', 'deprecated', 0, 1, '2012-02-03 03:25:24', '2012-02-08 03:21:04', '0', '');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `dinco_viewlevels`
--

CREATE TABLE IF NOT EXISTS `dinco_viewlevels` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) NOT NULL COMMENT 'JSON encoded access control.',
...
--
-- Volcar la base de datos para la tabla `dinco_viewlevels`
--

INSERT INTO `dinco_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
...
--
-- Estructura de tabla para la tabla `dinco_weblinks`
--

CREATE TABLE IF NOT EXISTS `dinco_weblinks` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `catid` int(11) NOT NULL DEFAULT '0',
...
--
-- Volcar la base de datos para la tabla `dinco_weblinks`
--
