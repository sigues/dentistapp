...
<table width ="100%">
    <tr>
        <td><?=anchor(base_url().'index.php/personal/agenda','<div class="boton200"></div><br/>
							    <div class="linkMenu">Agendar Citas</div>')?></td>
        <td><?=anchor(base_url().'index.php/personal/altaTratamientos','<div class="boton200"></div><br/>
							    <div class="linkMenu">Nuevo Tratamiento</div>')?></td>
        <td><?=anchor(base_url().'index.php/personal/seguimientoTratamiento','<div class="boton200"></div><br/>
							    <div class="linkMenu">Seguimiento de Tratamiento</div>')?></td>
            </tr>
    <tr>
        <td><?=anchor(base_url().'index.php/personal/altaPacientes','<div class="boton200"></div><br/>
